const assignment = {id: 1, title: "NodeJS Assignment", description: "Create a NodeJS with ExpressJS", due: "2021-10-10", completed: false, score: 0};
const module = {id: 1, name: "React", description: "Learn state management and lifecycle", course: "Web Development"};
